var VueAppConfiguration = {
    ...
    created() {
        ...
        var previousItemsSearchInputText = this.itemsSearchInputText;

        /* Filter function */
        setInterval(() => {
            if (previousItemsSearchInputText === this.itemsSearchInputText) { return undefined; };
            previousItemsSearchInputText = this.itemsSearchInputText;
            var searchText = this.itemsSearchInputText;
            ...
            if (searchText !== '') {
                this.items.sort(function (a, b) {
                    ...
                    if (a.label.toLowerCase().includes(searchText.toLowerCase()) === true) { ac++; };
                    if (b.label.toLowerCase().includes(searchText.toLowerCase()) === true) { bc++; };
                    if (ac !== bc) { return (bc - ac); };

                    if (a.details.toLowerCase().includes(searchText.toLowerCase()) === true) { ac++; };
                    if (b.details.toLowerCase().includes(searchText.toLowerCase()) === true) { bc++; };
                    if (ac !== bc) { return (bc - ac); };
